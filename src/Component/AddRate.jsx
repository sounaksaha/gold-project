...
export default function AddForm() {
  ...
  const onGoldSubmit = async () => {
    const data = { date, goldPrice };
    console.log(data);
    try {
      const response = await fetch("http://localhost:8080/api/goldprices", {
        method: "POST",
        headers: {
  ...
  const onSilverSubmit = async () => {
    ...
    console.log(data);
    try {
      const response = await fetch("http://localhost:8080/api/silverprices", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
                    ...
                    <form className="flex flex-col gap-4 mt-12">
                      ...
                      <div className="my-3">
                        ...
                        <div className="relative h-10 w-full min-w-[200px]">
                          ...
                          <input
                            type="number"
                            placeholder={`${activeTab} Price`} required
                            ...
                            value={
                              activeTab === "Gold" ? goldPrice : silverPrice
                            }
