    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `http://localhost:8080/api/transactions/${phoneNo}`
        );
        if (!response.ok) {
                  ...
                  {loading ? (
                    ...
                    currentItems.map((transaction, index) => (
                          ...
                          <div class="flex items-center">
                            ...
                            <div class="ml-4">
                              <div class="text-sm font-medium leading-5 text-gray-900">
                                <div class="flex items-center">
                                {`${('0' + new Date(transaction.transactionDateTime).getDate()).slice(-2)}/${('0' + (new Date(transaction.transactionDateTime).getMonth() + 1)).slice(-2)}/${new Date(transaction.transactionDateTime).getFullYear()}`}
                      ...
                      {customer.email}
                        ...
                        {/* <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                        {transaction.buySilverAmount} {` ₹`}
                        </td>
                        <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                        {transaction.buySilverQuantity} gm
                        </td>
                        <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                        {transaction.sellSilverAmount}{` ₹`} 
                        </td>
                        <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                        {transaction.sellSilverQuantity} gm
                        </td> */}
                      </tr>
                    ))
                  )}
