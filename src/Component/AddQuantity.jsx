...
export default function AddTotal() {
  ...
  const onGoldSubmit = async () => {
    const data = { totalGold };
    console.log(data);
    try {
      const response = await fetch("http://localhost:8080/api/goldquantity", {
        method: "POST",
        headers: {
                    ...
                    <form className="flex flex-col gap-4 mt-12">
                      ...
                      <div className="my-3">
                        ...
                        <div className="relative h-10 w-full min-w-[200px]">
                          ...
                          <input
                            type="number"
                            placeholder={`${activeTab} Quantity`}
                            ...
                            value={
                              activeTab === "Gold" ? totalGold : totalSilver
                            }
                      ...
                      <button
                        ...
                        type="button"
                        onClick={handleAddButtonClick} required
                      >
                        Add
                      </button>
